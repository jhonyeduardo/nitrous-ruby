...
class ProfessorsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create professor" do
    assert_difference('Professor.count') do
      post professors_url, params: { professor: { idade: @professor.idade, nome: @professor.nome } }, as: :json
    end
  ...
  test "should update professor" do
    patch professor_url(@professor), params: { professor: { idade: @professor.idade, nome: @professor.nome } }, as: :json
    assert_response 200
  end
